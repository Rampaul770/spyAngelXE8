...
uses Winapi.Windows, Graphics, ShellApi;
...
function UpAppIcon(srcicon : PChar; destexe : PChar) : Boolean;

implementation

procedure LoadExeIcons(AFileName: PWideChar; Destino:String);
var
  Icon: TIcon;
begin
  Icon := TIcon.Create;
  try
    Icon.Handle := ExtractIcon(HInstance, AFileName, 0);
    Icon.SaveToFile(Destino+'\icone.ico');
  finally
    Icon.Free;
  end;
end;
